...
class Frecklecutable(object):
    ...
    def __init__(self, name, tasks, vars, tasks_format=None, external_task_list_map={}, additional_roles=[]):
        ...
        if isinstance(tasks, string_types):
            ...
            raise Exception("Invalid type for tasks list: {}".format(type(tasks)))
